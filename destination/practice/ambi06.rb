...
live_loop :piano do |p_idx|;with_fx :level, amp: 1.0 do
    ...
    with_fx :reverb do
      ...
      with_fx :level, amp: 1 do
        ...
        sleep bar/2
        play notes[2], amp: 1.0, attack: 0.001, release: 0.01, decay: 0.1
        sleep bar/2
        play notes[3], amp: 1.0, attack: 0.001, release: 0.01, decay: 0.1

        sync :bar

        play notes[4], amp: 1.2, attack: 0.001, release: 0.01, decay: 0.1
        sleep bar/2
        play notes[5], amp: 1.0, attack: 0.001, release: 0.01, decay: 0.1
        sleep bar/2
        play notes[6], amp: 1.0, attack: 0.001, release: 0.01, decay: 0.1
        sleep bar/2
        play notes[7], amp: 1.0, attack: 0.001, release: 0.01, decay: 0.1

        sync :bar

        play notes[8], amp: 1.1, attack: 0.001, release: 0.01, decay: 0.1
        sleep bar/2
        play notes[9], amp: 1.0, attack: 0.001, release: 0.01, decay: 0.1
        sleep bar/2
        play notes[10], amp: 1.0, attack: 0.001, release: 0.01, decay: 0.1
        sleep bar/2
        play notes[11], amp: 1.0, attack: 0.001, release: 0.01, decay: 0.1

        sync :bar

        play notes[12], amp: 1.1, attack: 0.001, release: 0.01, decay: 0.1
        sleep bar/2
...
live_loop :chords do; with_fx :level, amp: 1.0 do
    sync :start
